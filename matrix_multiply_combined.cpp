...
namespace combined {
  ...
  matrix_multiply_combined::matrix_multiply_combined(size_t N, std::vector<double> &A, std::vector<double> &B,
  ...
  std::vector<double> matrix_multiply_combined::matrix_multiply() {
