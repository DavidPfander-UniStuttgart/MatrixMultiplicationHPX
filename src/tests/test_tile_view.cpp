...
void compare_tile(std::vector<double> &tiled_matrix,
  ...
  memory_layout::tile_view<2, double, std::allocator<double>> view(
      tiled_matrix, tile_index, tiling_info);
...
BOOST_AUTO_TEST_CASE(view) {
  ...
  // view on first tile
  std::array<size_t, 2> tile_index{0, 0};

  std::vector<double> reference_first = {
  ...
  std::vector<double> reference_first_end = {252,  253,  254,  255, 508, 509,
                                             510,  511,  764,  765, 766, 767,
                                             1020, 1021, 1022, 1023};
