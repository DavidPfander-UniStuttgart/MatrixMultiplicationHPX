...
cmake -DAUTOTUNETMP_ROOT=${AUTOTUNETMP_ROOT} -DVc_ROOT=${Vc_ROOT} -DCPPJIT_ROOT=${CPPJIT_ROOT} -DBOOST_ROOT=${BOOST_ROOT} -DCMAKE_BUILD_TYPE=RelWithDebInfo -DWITH_LIKWID=OFF ../
